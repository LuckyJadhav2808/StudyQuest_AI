...
Open `script.js` and update the Firebase configuration (lines 7-15):
...
Update the Supabase configuration in `script.js` (lines 19-20):
...
Update the OpenRouter API key in `script.js` (line 23):
